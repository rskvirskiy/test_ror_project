...
describe "User Pages" do
	...
	describe "edit" do
			...
			describe "with valid information" do
			    ...
			    before do
			        fill_in "Fullname",         with: new_name
	...
	describe "following/followers" do
		...
		describe "followed users" do
			...
			it { should have_link(other_user.fullname, href: user_path(other_user)) }
		end
		...
		describe "followers" do
			...
			it { should have_link(user.fullname, href: user_path(user)) }
		end
	end
