...
describe User do
	...
	before { @user = User.new(fullname: "Example User", email: "user@example.com", login: "emample_login", password: "foobar", password_confirmation: "foobar")}
	...
	describe "Micropost associations" do
		...
		it "should have rhe right microposts in the right order" do
